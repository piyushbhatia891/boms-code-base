...
$count="select * from bos_site_plan_test where country='$selected_country' and plan_site='$selected_plan' and plan_available NOT IN('Free') and plan_status='active' order by discount_price";
print($count);
